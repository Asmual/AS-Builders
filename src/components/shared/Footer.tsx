...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-gray-300 border-t border-slate-800/80">
      {/* Main Footer Content */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                href="#"
                aria-label="Facebook"
                className="w-9 h-9 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-gray-400 hover:text-yellow-500 hover:border-yellow-500 transition-all duration-200"
              >
      ...
      <div className="border-t border-slate-900 bg-slate-950/60 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500 gap-4">
